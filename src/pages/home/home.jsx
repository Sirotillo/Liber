  ...
  return (
    <>
      ...
      <section className="mt-10 mb-[62px]">
        <div className="container">
          <h2 className="font-semibold text-[32px] text-[#242424] mb-[24px]">
            Рукнлар
          </h2>
      ...
      <section className="mb-[64px]">
        <div className="container">
          ...
          <ProductWrapper path={"new-books"} className="mt-[32px]" />
        </div>
      </section>
      ...
      <section>
        <div className="container">
          ...
          <ProductWrapper path={"audio-books"} className="mt-[32px]" />
        </div>
      </section>
    </>
  );
